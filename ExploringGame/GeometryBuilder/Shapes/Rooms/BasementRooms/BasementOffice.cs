...
public class BasementOffice : Room
{
    ...
    public BasementOffice(WorldSegment worldSegment) : base(worldSegment)
    {
        ...
        this.SetWorldSide(Side.North, worldSegment.GetWorldSide(Side.North) + 1.9f);
    ...
    public void LoadChildren()
    {
        ...
        ceilingBar.SetWorldSideUnanchored(Side.East, eastPart.GetWorldSide(Side.East));
        ceilingBar.SetWorldSideUnanchored(Side.West, westPart.GetWorldSide(Side.West));
